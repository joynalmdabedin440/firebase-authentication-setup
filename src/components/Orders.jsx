    ...
    return (
        <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 bg-gray-50 text-gray-800 mx-auto">
            ...
            <div className="flex justify-end space-x-4">
                <button type="button" className="px-6 py-2 border rounded-md border-default-600">Back
                    <span className="sr-only sm:not-sr-only">to shop</span>
                </button>
                <button type="button" className="px-6 py-2 border rounded-md bg-default-600 text-gray-50 border-default-600">
